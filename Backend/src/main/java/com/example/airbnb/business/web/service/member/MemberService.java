...
import com.example.airbnb.business.core.repository.member.WishRepository;
...
public class MemberService {
    ...
    @Transactional
    public Wish addWish(WishAddRequest wishAddRequest) {
        Member member = memberRepository.findByGithubId(wishAddRequest.getGithubId())
